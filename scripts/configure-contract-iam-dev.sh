...
put_item "{\"pk\":{\"S\":\"APP#INDOMITO_HUB\"},\"sk\":{\"S\":\"APP#INDOMITO_HUB#LV1#PRG#LV2#CONTRACT_CREATE\"},\"code\":{\"S\":\"CONTRACT_CREATE\"},\"title\":{\"S\":\"Crear contrato\"},\"category\":{\"S\":\"Programas\"},\"path\":{\"S\":\"/contratos/nuevo\"},\"icon\":{\"S\":\"icon-[tabler--file-plus]\"},\"order\":{\"N\":\"2\"},\"active\":{\"BOOL\":true},\"level\":{\"S\":\"LV2\"},\"parentCode\":{\"S\":\"PRG\"},\"endpoints\":{\"L\":[{\"S\":\"/contratos\"},{\"S\":\"/contratos:pdf\"},{\"S\":\"/contratos:configuracion\"}]},\"createdAt\":{\"S\":\"$NOW\"}}"

put_item "{\"pk\":{\"S\":\"APP#INDOMITO_HUB\"},\"sk\":{\"S\":\"APP#INDOMITO_HUB#LV1#PRG#LV2#CONTRACT_LIST\"},\"code\":{\"S\":\"CONTRACT_LIST\"},\"title\":{\"S\":\"Listado de contratos\"},\"category\":{\"S\":\"Programas\"},\"path\":{\"S\":\"/contratos\"},\"icon\":{\"S\":\"icon-[tabler--file-description]\"},\"order\":{\"N\":\"3\"},\"active\":{\"BOOL\":true},\"level\":{\"S\":\"LV2\"},\"parentCode\":{\"S\":\"PRG\"},\"endpoints\":{\"L\":[{\"S\":\"/contratos\"}]},\"createdAt\":{\"S\":\"$NOW\"}}"
